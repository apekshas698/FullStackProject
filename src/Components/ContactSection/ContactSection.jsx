    ...
    <div data-aos="zoom-in" className="dark:bg-black dark:text-white py-14">
      <div className="container">
        ...
        <div className="col-span-2 space-y-3">
            ...
            <p className="text-gray-400">Whether you need a ride for a day or a fleet for your business, we're here to help.
              Partner with us for seamless booking, real-time management, and top-class service.
              Let’s drive your experience to the next level!</p>
        </div>
